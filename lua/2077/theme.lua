...
theme.set_highlights = function()
  ...
  hl(0, "Pmenu", { fg = c.light_purple, bg = c.alt_bg, sp = 'NONE', blend = 50, })
  hl(0, "PmenuSel", { fg = c.magenta, bg = c.royal })
  hl(0, "WildMenu", { fg = c.fg, bg = c.ui2_blue })
  hl(0, "CursorLineNr", { fg = c.magenta, bg = 'NONE', bold = true, })
  hl(0, "Comment", { fg = c.blue, bg = 'NONE', italic = true, })
  hl(0, "Folded", { fg = c.accent, bg = c.alt_bg })
  hl(0, "FoldColumn", { fg = c.accent, bg = c.alt_bg })
  hl(0, "LineNr", { fg = c.wine, bg = 'NONE' })
  hl(0, "FloatBorder", { fg = c.white, bg = c.alt_bg })
  hl(0, "Whitespace", { fg = c.bg, bg = 'NONE' })
  hl(0, "VertSplit", { fg = c.white, bg = c.bg })
  hl(0, "CursorLine", { fg = 'NONE', bg = c.cursor_fg })
  ...
  hl(0, "TermCursor", { fg = c.purp, bg = c.purp })
  hl(0, "TermCursorNC", { fg = c.purp, bg = c.purp })
  ...
  hl(0, "Variable", { fg = c.light_purple, bg = 'NONE' })
  ...
  hl(0, "Boolean", { fg = c.light_purp, bg = 'NONE' })
  ...
  hl(0, "Special", { fg = c.purp, bg = 'NONE' })
  hl(0, "SpecialChar", { fg = c.royal, bg = 'NONE' })
  ...
  hl(0, "cBlock", { fg = c.yellow, bg = 'NONE' })
  ...
  -- Lualine - Lualine colors done in the lualine config 
  ...
  hl(0, "markdownCode", { fg = c.royal, bg = 'NONE' })
  hl(0, "markdownCodeBlock", { fg = c.cursor_fg, bg = 'NONE' })
  hl(0, "markdownCodeDelimiter", { fg = c.purp, bg = 'NONE' })
  hl(0, "markdownH1", { fg = c.magenta, bg = 'NONE' })
  hl(0, "markdownH2", { fg = c.purp, bg = 'NONE' })
  hl(0, "markdownH3", { fg = c.cyan, bg = 'NONE' })
  hl(0, "markdownH4", { fg = c.yellow, bg = 'NONE' })
  hl(0, "markdownH5", { fg = c.seafoam, bg = 'NONE' })
  hl(0, "markdownH6", { fg = c.wine, bg = 'NONE' })
...
-- Render Markdown (https://github.com/MeanderingProgrammer/render-markdown.nvim)
  hl(0, "RenderMarkdownH1", { fg = 'NONE', bg = c.magenta })
  hl(0, "RenderMarkdownH2", { fg = 'NONE', bg = c.purp })
  hl(0, "RenderMarkdownH3", { fg = 'NONE', bg = c.cyan })
  hl(0, "RenderMarkdownH4", { fg = 'NONE', bg = c.yellow })
  hl(0, "RenderMarkdownH5", { fg = 'NONE', bg = c.wine })
  hl(0, "RenderMarkdownH6", { fg = 'NONE', bg = c.seafoam })
  hl(0, "RenderMarkdownH1Bg", { fg = c.cursor_fg, bg = c.magenta })
  hl(0, "RenderMarkdownH2Bg", { fg = c.cursor_fg, bg = c.purp })
  hl(0, "RenderMarkdownH3Bg", { fg = c.cursor_fg, bg = c.cyan })
  hl(0, "RenderMarkdownH4Bg", { fg = c.cursor_fg, bg = c.yellow })
  hl(0, "RenderMarkdownH5Bg", { fg = c.cursor_fg, bg = c.wine  })
  hl(0, "RenderMarkdownH6Bg", { fg = c.cursor_fg, bg = c.seafoam })
  hl(0, "RenderMarkdownCode", {fg = c.blue, bg = 'NONE'})
  hl(0, "RenderMarkdownCodeInfo", {fg = c.purp, bg = 'NONE'})
  hl(0, "RenderMarkdownCodeBorder", {fg = c.purp, bg = 'NONE'})
  hl(0, "RenderMarkdownCodeFallback", {fg = c.blue, bg = 'NONE'})
  hl(0, "RenderMarkdownCodeInline", {fg = c.royal, bg = 'NONE'})
  hl(0, "RenderMarkdownQuote", {fg = c.magenta, bg = 'NONE'})
  hl(0, "RenderMarkdownQuote1", {fg = c.purp, bg = 'NONE'})
  hl(0, "RenderMarkdownQuote2", {fg = c.cyan, bg = 'NONE'})
  hl(0, "RenderMarkdownQuote3", {fg = c.yellow, bg = 'NONE'})
  hl(0, "RenderMarkdownQuote4", {fg = c.wine, bg = 'NONE'})
  hl(0, "RenderMarkdownQuote5", {fg = c.seafoam, bg = 'NONE'})
  hl(0, "RenderMarkdownQuote6", {fg = c.blue, bg = 'NONE'})
  hl(0, "RenderMarkdownInlineHighlight", {fg = c.purp, bg = 'NONE'})
  hl(0, "RenderMarkdownBullet", {fg = c.magenta, bg = 'NONE'})
  hl(0, "RenderMarkdownDash", {fg = c.cyan, bg = 'NONE'})
  hl(0, "RenderMarkdownSign", {fg = c.cyan, bg = 'NONE'})
  hl(0, "RenderMarkdownMath", {fg = c.purp, bg = 'NONE'})
  hl(0, "RenderMarkdownIndent", {fg = c.royal, bg = 'NONE'})
  hl(0, "RenderMarkdownHtmlComment", {fg = c.royal, bg = 'NONE'})
  hl(0, "RenderMarkdownLink", {fg = c.magenta, bg = 'NONE'})
  hl(0, "RenderMarkdownLinkTitle", {fg = c.magenta, bg = 'NONE'})
  hl(0, "RenderMarkdownWikiLink", {fg = c.magenta, bg = 'NONE'})
  hl(0, "RenderMarkdownUnchecked", {fg = c.cursor_fg, bg = 'NONE'})
  hl(0, "RenderMarkdownChecked", {fg = c.royal, bg = 'NONE'})
  hl(0, "RenderMarkdownTodo", {fg = c.cyan, bg = 'NONE'})
  hl(0, "RenderMarkdownTableHead", {fg = c.magenta, bg = 'NONE'})
  hl(0, "RenderMarkdownSuccess", {fg = c.fg, bg = 'NONE'})
  hl(0, "RenderMarkdownInfo", {fg = c.blue, bg = 'NONE'})
  hl(0, "RenderMarkdownHint", {fg = c.solarorange, bg = 'NONE'})
  hl(0, "RenderMarkdownWarn", {fg = c.wine, bg = 'NONE'})
  hl(0, "RenderMarkdownError", {fg = c.red, bg = 'NONE'})
  ...
  -- RainbowDelimiters
  hl(0, "RainbowDelimiterRed", { fg = c.magenta, bg = 'NONE' })
  hl(0, "RainbowDelimiterYellow", { fg = c.yellow, bg = 'NONE' })
  hl(0, "RainbowDelimiterBlue", { fg = c.blue, bg = 'NONE' })
  hl(0, "RainbowDelimiterOrange", { fg = c.solarorange, bg = 'NONE' })
  hl(0, "RainbowDelimiterGreen", { fg = c.fg, bg = 'NONE' })
  hl(0, "RainbowDelimiterViolet", { fg = c.purp, bg = 'NONE' })
  ...
  -- StatusLine
  hl(0, "StatusLine", { fg = c.blue, bg = c.cursor_fg })
  hl(0, "StatusLineNC", { fg = c.blue, bg = c.cursor_fg })
  hl(0, "StatusLineSeparator", { fg = c.royal, bg = 'NONE' })
  hl(0, "StatusLineTerm", { fg = c.royal, bg = c.royal })
  hl(0, "StatusLineTermNC", { fg = c.royal, bg = 'NONE' })
  ...
  --Neovim Diagnositc
  hl(0, "DiagnosticError", { fg = c.wine, bg = 'NONE' })
  hl(0, "DiagnosticWarn", { fg = c.yellow, bg = 'NONE' })
  hl(0, "DiagnosticInfo", { fg = c.star_blue, bg = 'NONE' })
  hl(0, "DiagnosticHint", { fg = c.light_orange, bg = 'NONE' })
  hl(0, "DiagnosticOk", { fg = c.star_green, bg = 'NONE' })
  hl(0, "DiagnosticUnderlineError", { undercurl = true, sp = c.wine })
  hl(0, "DiagnosticUnderlineWarn", { undercurl = true, sp = c.yellow })
  hl(0, "DiagnosticUnderlineInfo", { undercurl = true, sp = c.star_blue })
  hl(0, "DiagnosticUnderlineHint", { undercurl = true, sp = c.light_orange })
  hl(0, "DiagnosticUnderlineOk", { undercurl = true, sp = c.star_green })
  hl(0, "DiagnosticVirtualTextError", { fg = c.wine, bg = 'NONE' })
  hl(0, "DiagnosticVirtualTextWarn", { fg = c.yellow, bg = 'NONE' })
  hl(0, "DiagnosticVirtualTextInfo", { fg = c.star_blue, bg = 'NONE' })
  hl(0, "DiagnosticVirtualTextHint", { fg = c.light_orange, bg = 'NONE' })
  hl(0, "DiagnosticVirtualTextOk", { fg = c.star_green, bg = 'NONE' })
  hl(0, "DiagnosticSignError", { fg = c.wine, bg = 'NONE' })
  hl(0, "DiagnosticSignWarn", { fg = c.yellow, bg = 'NONE' })
  hl(0, "DiagnosticSignInfo", { fg = c.star_blue, bg = 'NONE' })
  hl(0, "DiagnosticSignHint", { fg = c.light_orange, bg = 'NONE' })
  hl(0, "DiagnosticSignOk", { fg = c.star_green, bg = 'NONE' })
  hl(0, "DiagnosticFloatingError", { fg = c.wine, bg = 'NONE' })
  hl(0, "DiagnosticFloatingWarn", { fg = c.yellow, bg = 'NONE' })
  hl(0, "DiagnosticFloatingInfo", { fg = c.star_blue, bg = 'NONE' })
  hl(0, "DiagnosticFloatingHint", { fg = c.light_orange, bg = 'NONE' })
  hl(0, "DiagnosticFloatingOk", { fg = c.star_green, bg = 'NONE' })
end
