...
theme.set_highlights = function()
  ...
  hl(0, "Boolean", { fg = c.purp, bg = 'NONE' })
  ...
  hl(0, "@lsp.type.lifetime", { link = "@storageclass" })
  hl(0, "@lsp.type.macro", {}) -- Use fallback Tree-sitter style for this Semantic Token
  hl(0, "@lsp.type.magicFunction", { link = "@function" })
  hl(0, "@lsp.type.namespace", { link = "@namespace" })
  hl(0, "@lsp.type.operator", {}) -- Use fallback Tree-sitter style for this Semantic Token
  hl(0, "@lsp.type.parameter", { link = "@parameter" })
  hl(0, "@lsp.type.selfKeyword", { link = "@variable.builtin" })
  hl(0, "@lsp.type.selfParameter", { link = "@variable.builtin" })
  hl(0, "@lsp.type.typeAlias", { link = "@type.definition" })
  hl(0, "@lsp.type.unresolvedReference", { undercurl = true, sp = red })
  hl(0, "@lsp.type.variable", {}) -- Use fallback Tree-sitter style for this Semantic Token
  hl(0, "@lsp.typemod.class.defaultLibrary", { link = "@type" })
  hl(0, "@lsp.typemod.enum.defaultLibrary", { link = "@type" })
  ...
  hl(0, "@lsp.typemod.struct.defaultLibrary", { link = "@type" })
